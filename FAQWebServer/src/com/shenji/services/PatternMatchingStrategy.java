...
import com.shenji.inerface.PatternMatchingStrategyInter;
...
public class PatternMatchingStrategy {
	...
	private PatternMatchingStrategyInter strategyInter;
	...
	class deleteRules implements PatternMatchingStrategyInter{
	...
	class useOnlyOneLineRules implements PatternMatchingStrategyInter{
		public String getResult(String args, String matcher) {
			// TODO Auto-generated method stub
			String result=args;
			//if(args.matches(matcher)){
	...
	class billNum implements PatternMatchingStrategyInter{
		public String getResult(String args, String matcher) {
			// TODO Auto-generated method stub
			Pattern pattern=Pattern.compile(matcher); 
			Matcher m=pattern.matcher(args);
