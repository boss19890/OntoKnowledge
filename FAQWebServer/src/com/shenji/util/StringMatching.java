...
public class StringMatching {
	 ...
	 * 
	 * 这是�?��字符串之间相似度计算的方法�?
	 * 给定字符串S、T，将S转换T�?��要的插入、删除�?替代操作的数量叫做S到T的编辑路径�?
	 * 其中�?��的路径叫做编辑距离�?
	 * 
	...
	public static int strEditDistance(String stringOne,String stringTwo){
		...
		for(int i=1;i<stringOneLength+1;i++)
		{
			...
			for(int j=1;j<stringTwoLength+1;j++)
			{
				...
				editArray[i][j] = minDistance(editArray[i-1][j]+1, editArray[i][j-1]+1, editArray[i-1][j-1]+temp);
			}
	...
	*/  
	...
	/** 
     * 单字符间是否替换  
	 * isModify(a,b)表示a字符转换到b字符�?��要的操作次数�?
	 * 如果a==b，则不需要任何操作isModify(a, b)=0�?否则，需要替换操作，isModify(a, b)=1�?
	 * @param a 字符a
	 * @param b 字符b
	 * @return �?��替换，返�?；否则，返回0 
	*/  
	 ...
	 public static double getDistanceSimilarity(String str1, String str2) {
	 ...
	 public static void main(String[] str){
		 System.out.println(questionMatching("\n sdfsdfsdf \n sdfsdfsdfsdf,fdsfsdfsdf"));
	 }
