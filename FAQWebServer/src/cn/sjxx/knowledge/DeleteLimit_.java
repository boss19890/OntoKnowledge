 ...
 */
            ...
            /**
            *  DeleteLimit_ bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class DeleteLimit_
    ...
    public static class Factory{
        ...
        */
        public static DeleteLimit_ parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DeleteLimit_ object =
                new DeleteLimit_();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"deleteLimit_".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DeleteLimit_)cn.sjxx.knowledge.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
