 ...
 */
            ...
            /**
            *  DeleteCharacteristics bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class DeleteCharacteristics
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                        ...
                        /**
                        * field for CharacteristicsType
                        */

                        
                                    protected int localCharacteristicsType ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localCharacteristicsTypeTracker = false ;

                           public boolean isCharacteristicsTypeSpecified(){
                               return localCharacteristicsTypeTracker;
                           }
                           ...
                           */
                           public  int getCharacteristicsType(){
                               return localCharacteristicsType;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param CharacteristicsType
                               */
                               public void setCharacteristicsType(int param){
                            
                                       // setting primitive attribute tracker to true
                                       localCharacteristicsTypeTracker =
                                       param != java.lang.Integer.MIN_VALUE;
                                   
                                            this.localCharacteristicsType=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":deleteCharacteristics",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "deleteCharacteristics",
                ...
                if (localTokenTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localCharacteristicsTypeTracker){
                                    namespace = "http://knowledge.sjxx.cn";
                                    writeStartElement(null, namespace, "characteristicsType", xmlWriter);
                             
                                               if (localCharacteristicsType==java.lang.Integer.MIN_VALUE) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("characteristicsType cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCharacteristicsType));
                                               }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localTokenTracker){
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCharacteristicsType));
                            }
    ...
    public static class Factory{
        ...
        */
        public static DeleteCharacteristics parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DeleteCharacteristics object =
                new DeleteCharacteristics();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"deleteCharacteristics".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DeleteCharacteristics)cn.sjxx.knowledge.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://knowledge.sjxx.cn","characteristicsType").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"characteristicsType" +"  cannot be null");
                                    }
                                    

                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setCharacteristicsType(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(content));
                                        ...
                                        reader.next();
                                               ...
                                               object.setCharacteristicsType(java.lang.Integer.MIN_VALUE);
