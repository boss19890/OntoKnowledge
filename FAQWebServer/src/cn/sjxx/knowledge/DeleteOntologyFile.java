 ...
 */
            ...
            /**
            *  DeleteOntologyFile bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class DeleteOntologyFile
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":deleteOntologyFile",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "deleteOntologyFile",
    ...
    public static class Factory{
        ...
        */
        public static DeleteOntologyFile parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DeleteOntologyFile object =
                new DeleteOntologyFile();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"deleteOntologyFile".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DeleteOntologyFile)cn.sjxx.knowledge.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
