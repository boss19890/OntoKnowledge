 ...
 */
            ...
            /**
            *  CreateFaqIndividual bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CreateFaqIndividual
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":createFaqIndividual",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "createFaqIndividual",
    ...
    public static class Factory{
        ...
        */
        public static CreateFaqIndividual parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CreateFaqIndividual object =
                new CreateFaqIndividual();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"createFaqIndividual".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CreateFaqIndividual)cn.sjxx.knowledge.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
