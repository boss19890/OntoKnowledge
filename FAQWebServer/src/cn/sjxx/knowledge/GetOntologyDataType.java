 ...
 */
            ...
            /**
            *  GetOntologyDataType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetOntologyDataType
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getOntologyDataType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getOntologyDataType",
    ...
    public static class Factory{
        ...
        */
        public static GetOntologyDataType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetOntologyDataType object =
                new GetOntologyDataType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getOntologyDataType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetOntologyDataType)cn.sjxx.knowledge.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
