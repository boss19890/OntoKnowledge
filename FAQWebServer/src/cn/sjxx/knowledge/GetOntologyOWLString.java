 ...
 */
            ...
            /**
            *  GetOntologyOWLString bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetOntologyOWLString
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://knowledge.sjxx.cn",
                "getOntologyOWLString",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getOntologyOWLString",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getOntologyOWLString",
    ...
    public static class Factory{
        ...
        */
        public static GetOntologyOWLString parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetOntologyOWLString object =
                new GetOntologyOWLString();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getOntologyOWLString".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetOntologyOWLString)cn.sjxx.knowledge.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
