 ...
 */
            ...
            /**
            *  CloseOntologyFile bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CloseOntologyFile
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":closeOntologyFile",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "closeOntologyFile",
    ...
    public static class Factory{
        ...
        */
        public static CloseOntologyFile parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CloseOntologyFile object =
                new CloseOntologyFile();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"closeOntologyFile".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CloseOntologyFile)cn.sjxx.knowledge.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
