 ...
 */
            ...
            /**
            *  DeleteIndividualType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class DeleteIndividualType
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":deleteIndividualType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "deleteIndividualType",
    ...
    public static class Factory{
        ...
        */
        public static DeleteIndividualType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DeleteIndividualType object =
                new DeleteIndividualType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"deleteIndividualType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DeleteIndividualType)cn.sjxx.knowledge.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
