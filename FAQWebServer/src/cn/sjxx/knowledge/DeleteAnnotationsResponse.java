...
/**
 * DeleteAnnotationsResponse.java
 *
 ...
 */
            ...
            /**
            *  DeleteAnnotationsResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class DeleteAnnotationsResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":deleteAnnotationsResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "deleteAnnotationsResponse",
    ...
    public static class Factory{
        ...
        */
        public static DeleteAnnotationsResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DeleteAnnotationsResponse object =
                new DeleteAnnotationsResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"deleteAnnotationsResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DeleteAnnotationsResponse)cn.sjxx.knowledge.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
