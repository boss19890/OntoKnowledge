 ...
 */
            ...
            /**
            *  SetLimit_Response bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SetLimit_Response
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":setLimit_Response",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "setLimit_Response",
    ...
    public static class Factory{
        ...
        */
        public static SetLimit_Response parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SetLimit_Response object =
                new SetLimit_Response();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"setLimit_Response".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SetLimit_Response)cn.sjxx.knowledge.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
