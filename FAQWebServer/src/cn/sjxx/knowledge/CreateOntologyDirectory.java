 ...
 */
            ...
            /**
            *  CreateOntologyDirectory bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CreateOntologyDirectory
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":createOntologyDirectory",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "createOntologyDirectory",
    ...
    public static class Factory{
        ...
        */
        public static CreateOntologyDirectory parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CreateOntologyDirectory object =
                new CreateOntologyDirectory();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"createOntologyDirectory".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CreateOntologyDirectory)cn.sjxx.knowledge.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
