 ...
 */
            ...
            /**
            *  GetMyWordSet bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetMyWordSet
    ...
    public static class Factory{
        ...
        */
        public static GetMyWordSet parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetMyWordSet object =
                new GetMyWordSet();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getMyWordSet".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetMyWordSet)cn.sjxx.knowledge.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
