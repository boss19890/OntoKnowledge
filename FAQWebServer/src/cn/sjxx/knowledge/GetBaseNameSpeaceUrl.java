 ...
 */
            ...
            /**
            *  GetBaseNameSpeaceUrl bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetBaseNameSpeaceUrl
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getBaseNameSpeaceUrl",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getBaseNameSpeaceUrl",
    ...
    public static class Factory{
        ...
        */
        public static GetBaseNameSpeaceUrl parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetBaseNameSpeaceUrl object =
                new GetBaseNameSpeaceUrl();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getBaseNameSpeaceUrl".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetBaseNameSpeaceUrl)cn.sjxx.knowledge.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
