 ...
 */
            ...
            /**
            *  DeleteOntologyObject bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class DeleteOntologyObject
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":deleteOntologyObject",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "deleteOntologyObject",
    ...
    public static class Factory{
        ...
        */
        public static DeleteOntologyObject parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DeleteOntologyObject object =
                new DeleteOntologyObject();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"deleteOntologyObject".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DeleteOntologyObject)cn.sjxx.knowledge.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
