 ...
 */
            ...
            /**
            *  GetAnnotationsType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAnnotationsType
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getAnnotationsType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getAnnotationsType",
    ...
    public static class Factory{
        ...
        */
        public static GetAnnotationsType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAnnotationsType object =
                new GetAnnotationsType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getAnnotationsType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAnnotationsType)cn.sjxx.knowledge.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
