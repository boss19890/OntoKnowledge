...
/**
 * GetOntologyDescriptionObject.java
 *
 ...
 */
            ...
            /**
            *  GetOntologyDescriptionObject bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetOntologyDescriptionObject
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://knowledge.sjxx.cn",
                "getOntologyDescriptionObject",
                "ns1");
                        ...
                        */
                        ...
                        /**
                        * field for Transitive
                        */

                        
                                    protected boolean localTransitive ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localTransitiveTracker = false ;

                           public boolean isTransitiveSpecified(){
                               return localTransitiveTracker;
                           }
                           ...
                           */
                           public  boolean getTransitive(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param Transitive
                               */
                               public void setTransitive(boolean param){
                            
                                       // setting primitive attribute tracker to true
                                       localTransitiveTracker =
                                       true;
                                   
                                            this.localTransitive=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getOntologyDescriptionObject",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getOntologyDescriptionObject",
                ...
                if (localTokenTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localTransitiveTracker){
                                    namespace = "http://knowledge.sjxx.cn";
                                    writeStartElement(null, namespace, "transitive", xmlWriter);
                             
                                               if (false) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("transitive cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localTransitive));
                                               }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localTokenTracker){
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localTransitive));
                            } if (localDescriptionTypeTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://knowledge.sjxx.cn",
                                                                      "descriptionType"));
    ...
    public static class Factory{
        ...
        */
        public static GetOntologyDescriptionObject parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetOntologyDescriptionObject object =
                new GetOntologyDescriptionObject();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getOntologyDescriptionObject".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetOntologyDescriptionObject)cn.sjxx.knowledge.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://knowledge.sjxx.cn","transitive").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"transitive" +"  cannot be null");
                                    }
                                    

                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setTransitive(
