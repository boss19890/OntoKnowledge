 ...
 */
            ...
            /**
            *  AddAnnotationsResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AddAnnotationsResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":addAnnotationsResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "addAnnotationsResponse",
    ...
    public static class Factory{
        ...
        */
        public static AddAnnotationsResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AddAnnotationsResponse object =
                new AddAnnotationsResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"addAnnotationsResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AddAnnotationsResponse)cn.sjxx.knowledge.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
