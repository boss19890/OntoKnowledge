 ...
 */
            ...
            /**
            *  SetLimit_ bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SetLimit_
    ...
    public static class Factory{
        ...
        */
        public static SetLimit_ parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SetLimit_ object =
                new SetLimit_();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"setLimit_".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SetLimit_)cn.sjxx.knowledge.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
