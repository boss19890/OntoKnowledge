 ...
 */
            ...
            /**
            *  DeleteOntologyDirectory bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class DeleteOntologyDirectory
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":deleteOntologyDirectory",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "deleteOntologyDirectory",
    ...
    public static class Factory{
        ...
        */
        public static DeleteOntologyDirectory parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DeleteOntologyDirectory object =
                new DeleteOntologyDirectory();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"deleteOntologyDirectory".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DeleteOntologyDirectory)cn.sjxx.knowledge.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
